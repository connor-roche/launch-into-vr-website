...
const DownloadsContent = () => (
	...
	<h3 className={classes.subTitle}>Unity Package <span className={classes.versionId}>(Version 2018.1+)</span></h3>
	...
	<h3 className={classes.subTitle}>APK <span className={classes.versionId}>(API 24+)</span></h3>
